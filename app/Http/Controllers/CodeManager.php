...
class CodeManager extends Controller
{
    ...
    private function execBashCommand($path = null, $forder = null, $imageBuildDocker = null, $type = null, $extensionFile = null)
    {
        ...
        // dd($command);
        $content = exec($command); // Exec run file
        return $content;
    }
    ...
    private function acrMultyLgCode($lg = [], $imageBuildDocker = null, $path = null, $content): array
    {
        ...
        $this->createWriteRemoveAndOpenFile($path, $forder, $extensionFile, $content); // Open
        $content = $this->execBashCommand($path, $forder, $imageBuildDocker, $type, $extensionFile);
        $result = $this->readFile($path, $forder); // Read
        $this->createWriteRemoveAndOpenFile($path, $forder, $extensionFile, null, true); // Remove
